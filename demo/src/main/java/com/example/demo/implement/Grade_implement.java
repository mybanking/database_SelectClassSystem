...
@Service
public class Grade_implement implements Load_grade_service {
    ...
    public JSONObject search_grade(String id,String year) {
        List<return_search_grade> search_grades = mapper.search_grade(id, year);
        JSONObject res = new JSONObject();
