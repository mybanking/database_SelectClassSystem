function auto_create_table_grade(data) {
    ...
    $(function(){
        ...
        for( var i = 0; i < data.length; i++ ) {
            ...
            tab=tab+"<td class='color_1'>"+data[i].courseName+"</td>";
            tab=tab+"<td class='color_1'>"+data[i].teacherName+"</td>";
            tab=tab+"<td class='color_1'>"+data[i].credit+"</td>";
            tab=tab+"<td class='color_1'>"+data[i].p_grade+"</td>";
            tab=tab+"<td class='color_1'>"+data[i].grade+"</td>";
            tab=tab+"<td class='color_1'>"+data[i].total_grade+"</td>";
            tab=tab+"</tr>";
            if (count < size) {
                //第一页显示的数量
